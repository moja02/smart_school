...
<div class="container-fluid py-4">
    ...
    <div class="card page-header-card mb-4 shadow border-0">
        <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h2 class="fw-bold mb-1 text-dark">⚙️ إدارة تفضيلات المعلمين</h2>
                <p class="mb-0 text-muted">عرض وتعديل أوقات العمل المفضلة لكل معلم قبل توليد الجدول.</p>
            </div>
            <div class="text-end d-flex gap-2">
                <a href="{{ route('admin.schedule.index') }}" class="btn btn-light shadow-sm text-primary fw-bold">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted fw-bold">
                                <i class="fas fa-info-circle fa-2x mb-3 d-block text-secondary"></i> لا يوجد معلمين متاحين حالياً لعرضهم.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
